    ...
    public partial class UserTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationFolders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationFolders_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationFolderJobApplication",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationFolderJobApplication", x => new { x.ApplicationsId, x.FoldersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationFolderJobApplication_FoldersId",
                table: "ApplicationFolderJobApplication",
                column: "FoldersId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationFolders_OwnerId",
                table: "ApplicationFolders",
                column: "OwnerId");

...
import { prefetchApplications,prefetchAllApplications } from "@/hooks/use-folder";
...
export function FolderGrid() {
  ...
  const visibleFolders = showAll ? filteredFolders : filteredFolders.slice(0, folderPerRow - 1);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={cn(
        ...
        <Link
            to={"/folder/all"}
            onMouseEnter={() => prefetchAllApplications(queryClient)}

...
export function FilterValueDisplay(
  ...
  switch (column.type) {
    case 'option':
      return (<FilterValueOptionDisplay filter={filter} column={column} actions={actions} locale={locale} />);
    case 'multiOption':
      return (<FilterValueMultiOptionDisplay filter={filter} column={column} actions={actions} locale={locale} />);
    case 'date':
      return (<FilterValueDateDisplay filter={filter} column={column} actions={actions} locale={locale} />);
    case 'text':
      return (<FilterValueTextDisplay filter={filter} column={column} actions={actions} locale={locale} />);
    case 'number':
      return (<FilterValueNumberDisplay filter={filter} column={column} actions={actions} locale={locale} />);
    default:
      return null
  }
}
...
export function FilterValueOptionController(
  ...
  const handleToggle = useCallback((value, checked) => {
